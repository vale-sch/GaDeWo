    ...
    void CheckInput() {
        ...
        if (Input.GetKey(KeyCode.Mouse0)) {
            if (weaponType == "rail") {
                ...
                GameData.weaponEnergy -= 0.05f;
                energyBar.SetFillAmount("Weapon");
                this.transform.GetChild(this.transform.childCount - 1).GetComponent<LaserMachine>().m_inspectorProperties.m_maxRadialDistance += 0.1f;
            }
